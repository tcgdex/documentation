...
description: Apprenez à installer et utiliser le SDK JavaScript TCGdex pour accéder aux données du JCC Pokémon
---
...
- [Consultez la documentation complète de l'API REST](/rest) pour tous les endpoints disponibles
