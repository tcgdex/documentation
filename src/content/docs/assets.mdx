...
```url
https://assets.tcgdex.net/swsh/swsh3/swsh3-136
```
...
<Tabs>
	<TabItem label="Cards">
		...
		```bash
		https://assets.tcgdex.net/swsh/swsh3/swsh3-136/{quality}.{extension}
		```
	...
	<TabItem label="Symbols/Logos">
		...
		```bash
		https://assets.tcgdex.net/swsh/swsh3/symbol.{extension}
		```
