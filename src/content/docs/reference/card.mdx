...
| Property                                 | Type                     | Required | Description                                   |
|------------------------------------------|--------------------------|----------|-----------------------------------------------|
| `pricing.tcgplayer.productId`            | Number                   | ✅        | The unique tcgplayer id for this card         |
| `pricing.tcgplayer.updated`              | String                   | ✅        | Indicate when is the last time it was fetched |
| `pricing.tcgplayer.unit`                 | String                   | ✅        | Indicate the unit in which the card is sold   |
...
| Property                        | Type   | Required | Description                                   |
|---------------------------------|--------|----------|-----------------------------------------------|
| `pricing.cardmarket.idProduct`  | Number | ❌        | The unique cardmarket id for this card        |
| `pricing.cardmarket.updated`    | String | ❌        | Indicate when is the last time it was fetched |
| `pricing.cardmarket.unit`       | String | ❌        | Indicate the unit in which the card is sold   |
